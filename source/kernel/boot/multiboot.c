...
// TODO: Refactor whole interaction with multiboot structure
//       Probably add multi-stage parsing where first stage gets necessary info
//       to setup heap, and second stage parses all data using that heap into
